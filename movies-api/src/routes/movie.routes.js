...
// POST
routes.post('/', authenticate, validator.body(validators.createMovie), MovieController.createMovie);

// PUT
routes.put('/', authenticate, validator.body(validators.updateMovie), MovieController.updateMovie);
